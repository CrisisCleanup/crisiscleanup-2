...
ActiveRecord::Schema.define(version: 20170901011220) do
  ...
  create_table "legacy_contacts", id: :serial, force: :cascade do |t|
  ...
  create_table "legacy_events", id: :serial, force: :cascade do |t|
  ...
  create_table "legacy_organization_events", id: :serial, force: :cascade do |t|
    t.integer "legacy_organization_id", null: false
    t.integer "legacy_event_id", null: false
  end

  create_table "legacy_organizations", id: :serial, force: :cascade do |t|
    t.date "activate_by"
    t.date "activated_at"
  ...
  create_table "legacy_sites", id: :serial, force: :cascade do |t|
    ...
    t.integer "user_id"
    t.index ["claimed_by"], name: "index_legacy_sites_on_claimed_by"
    t.index ["legacy_event_id"], name: "index_legacy_sites_on_legacy_event_id"
    t.index ["reported_by"], name: "index_legacy_sites_on_reported_by"
  end

  create_table "request_invitations", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.integer "legacy_organization_id"
  ...
  create_table "temporary_passwords", id: :serial, force: :cascade do |t|
